...
def main(config):
    ...
    if config.mode == 'train':
        ...
        solver.test()
    elif config.mode =='retrieval':
        solver.img_retrieval()
...
if __name__ == '__main__':
    ...
    #=======deokyun edit
    parser.add_argument('--mode', type=str , default='train', help='train|test|retrieval')
    parser.add_argument('--txt_file', type=str, default='trainvalids.txt', help='trainvalids.txt|valids.txt')
    # parser.add_argument('--valid_file', type=str, default='valids.txt', help='file specifying which class labels are used for training. Can also be trainvalids.txt')
    #===================
    ...
    #====>deokyun edit
    parser.add_argument('--init_from', type=str, default='40000', help='initialize network parameters from checkpoint at this path')
