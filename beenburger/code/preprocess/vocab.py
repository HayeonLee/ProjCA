# refer code: https://github.com/fartashf/vsepp/blob/master/vocab.py
...
def main(data_path, data_name):
    ...
    path = os.path.join(data_path, data_name, 'annotations')
    with open('../vocab/{}_vocab.pkl'.format(data_name), 'wb') as f:
        pickle.dump(vocab, f, pickle.HIGHEST_PROTOCOL)
    print("Saved vocabulary file to ", '../vocab/{}_vocab.pkl'.format(data_name))

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', default='/DATA/cvpr19')
    parser.add_argument('--data_name', default='coco',
                        help='coco_precomp|coco')
